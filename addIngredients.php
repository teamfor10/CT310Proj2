...
<div id="addIngForm">
    ...
    <form name='input' action="<?php echo $_SERVER['PHP_SELF']; ?>" method='post' id="formInput" align="center"> 
        ...
        <textarea value='<?php echo $description; ?>' style="margin-top: 25px; margin-left: 50px;" rows="4" cols="50" id="formInput" placeholder='Enter description'></textarea>
        <br/>
        
        <textarea  value=''<?php echo $attributes; ?>' style="margin-top: 25px; margin-left: 50px;" rows="4" cols="50" id="formInput" placeholder='Enter Attributes'></textarea>
        <br/>

        <input type='submit' value='submitfrm' name='submitfrm' class="submitfrm" />
